...
export const maxPageNumber = (per: number, max_offset: number = MAX_OFFSET): number => {
...
export const actualMaxPageNumber = (per: number, count: number, max_offset: number = MAX_OFFSET): number =>
